 ...
 ****************************************************************************************************************************/
  ...
  Serial.println("7");
                  //(SD,  BA,  SH,   EL,   WV,  WR,  GR);
  RoboticArmMovement(20,  172, 140,  150,  81,  90,  57);
  // Wait 1 second recommended for power to discharge from the servos
  delay(1000);
 ...
 ****************************************************************************************************************************/
   ...
   Serial.println("8");
                  //(SD,  BA,   SH,   EL,   WV,  WR,  GR);
  RoboticArmMovement(20,  172,  140,  150,  81,  90,  30);
  //Wait 1 second recommended for power to discharge from the servos 
  delay(1000);
 ...
 ****************************************************************************************************************************/
 ...
 Serial.println("25");
                  //(SD,  BA,   SH,   EL,   WV,  WR,  GR);
  RoboticArmMovement(20,  100,  82,   82,   82,  82,  30);
  //Wait 1 second recommended for power to discharge from the servos 
  delay(1000);
 ...
 ****************************************************************************************************************************/
  ...
  Serial.println("26");
                  //(SD,  BA,   SH,   EL,   WV,  WR,  GR);
  RoboticArmMovement(20,  172,  80,   82,   82,  90,  30);
  //Wait 1 second recommended for power to discharge from the servos 
  delay(1000);
 ...
 ****************************************************************************************************************************/
   ...
   Serial.println("34");
                  //(SD,  BA,   SH,   EL,   WV,  WR,  GR);
  RoboticArmMovement(20,  151,  82,   82,   82,  90,  30);
  //Wait 1 second recommended for power to discharge from the servos 
  delay(1000);
 ...
 ****************************************************************************************************************************/
   ...
   Serial.println("35");
                  //(SD,  BA,   SH,   EL,   WV,  WR,  GR);
  RoboticArmMovement(20,  151,  123,   135,   154,  90,  30);
  //Wait 1 second recommended for power to discharge from the servos 
  delay(1000);
 ...
 ****************************************************************************************************************************/
    ...
    Serial.println("36");
                  //(SD,  BA,   SH,   EL,   WV,  WR,  GR);
  RoboticArmMovement(20,  151,  123,   135,   154,  90,  57);
  //Wait 1 second recommended for power to discharge from the servos 
  delay(1000);
 ...
 ****************************************************************************************************************************/
       ...
       Serial.println("42");
                  //(SD,  BA,   SH,   EL,   WV,  WR,  GR);
  RoboticArmMovement(20,  100,  82,   82,  82,  90,  30);
  //Wait 1 second recommended for power to discharge from the servos 
  delay(1000);
